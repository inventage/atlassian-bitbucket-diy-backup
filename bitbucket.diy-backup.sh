...
if [ -f ${SCRIPT_DIR}/bitbucket.diy-backup.vars.sh ]; then
    source ${SCRIPT_DIR}/bitbucket.diy-backup.vars.sh
else
    error "${SCRIPT_DIR}/bitbucket.diy-backup.vars.sh not found"
...
if [ -e "${SCRIPT_DIR}/bitbucket.diy-backup.${BACKUP_HOME_TYPE}.sh" ]; then
    ...
    bail "Please update BACKUP_HOME_TYPE in ${SCRIPT_DIR}/bitbucket.diy-backup.vars.sh"
fi
...
if [ -e "${SCRIPT_DIR}/bitbucket.diy-backup.${BACKUP_DATABASE_TYPE}.sh" ]; then
    ...
    bail "Please update BACKUP_DATABASE_TYPE in ${SCRIPT_DIR}/bitbucket.diy-backup.vars.sh"
fi
